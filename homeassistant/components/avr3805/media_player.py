...
NORMAL_INPUTS = {'PHONO':'Phono', 'CD':'CD', 'TUNER':'Tuner',
                 'DVD':'DVD', 'VDP':'VDP', 'TV':'TV',
                 'Satelite / Cable':'DBS/SAT', 'VCR 1':'VCR-1',
                 'VCR 2':'VCR-2', 'VCR 3':'VCR-3', 'Video Aux':'V.AUX',
                 'CD-R/Tape 1':'CDR/TAPE1', 'MD/Tape 2':'MD/TAPE2',
                 'USB':'USB', 'IPOD':'IPOD' }
...
class DenonDevice(MediaPlayerDevice):
    ...
    def volume_up(self):
        ...
        self.serial_command('MVUP')

    def volume_down(self):
        """Volume down media player."""
        self.serial_command('MVDOWN')

    def set_volume_level(self, volume):
        """Set volume level, range 0..1."""
        self.serial_command('MV' +
